...
- The shared [office-source-policy.md](references/office-source-policy.md) is the single policy file for this decision; an explicit user instruction not to render is a hard stop.
