...
公开仓库不包含客户文件、具体案件事实、私有提示词、用户专属偏好、保密模板、凭据或已登录服务信息。

## 快速开始

建议先阅读 [`OPEN_SOURCE_BOUNDARY.md`](OPEN_SOURCE_BOUNDARY.md)，再阅读 [`docs/architecture.md`](docs/architecture.md) 以及你准备使用的 Skill 或工作空间文档。
