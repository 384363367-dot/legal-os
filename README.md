...
**下载提示：** 推荐从 [GitHub Releases](https://github.com/384363367-dot/legal-os/releases/tag/v0.2.0) 下载 v0.2.0 公开预发布版；从默认 `main` 分支克隆或点击 **Code → Download ZIP**，获得发布后的最新开发内容。预发布版仍可能继续调整，生产使用前请执行仓库验证和事项级法律审查。
...
当前公开预发布版本为 v0.2.0。在首个稳定版本发布前，接口、模块边界和仓库结构仍可能调整。版本变更见 [`CHANGELOG.md`](CHANGELOG.md)。
