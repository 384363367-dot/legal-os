...
> **2026-07-23 · v0.3.0 公开候选版（尚未发布）**

- 新增独立的 `legal-quality-gate`，统一复核事实、证据、现行法、表达边界、隐私、人工签核和交付状态；
- 新增可执行发布锁及合成 Schema，以 `BLOCKED`、`DRAFT_ONLY`、`RELEASE` 表达机器判定；
- 公共目录边界改为调用方显式声明，不包含个人路径、客户数据、组织专用规则或写死的仓库位置；
- 这是发布闸门中的候选版本，尚未合并到正式公开源，也未创建 GitHub Release。

**下载提示：** 最近已发布版本仍为 [v0.2.0](https://github.com/384363367-dot/legal-os/releases/tag/v0.2.0)。v0.3.0 在完成候选审查、合并和发布前不得描述为已公开发布版本。
...
- 11 个公开候选 Legal OS Skills 及其工作流参考；
...
当前候选版本为 v0.3.0，最近已发布的公开预发布版本为 v0.2.0。在首个稳定版本发布前，接口、模块边界和仓库结构仍可能调整。版本变更见 [`CHANGELOG.md`](CHANGELOG.md)。
