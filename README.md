...
> **2026-07-29 · v0.5.0 公开预发布版**

- 为原告、申请人和债权人的首次请求文书增加单一立场门；
- 将首次申请、内部分析、庭审提纲、质证意见和调查取证申请按程序功能分层；
- 对假设性或条件性表达实行语境复核与可追溯例外，不采用机械禁词；
...
- 提供 12 个可安装 Skill、24 个去身份化 Office 模板、15 个合成路由场景和 49 项自动化测试。

**下载：** 请从 [GitHub Releases](https://github.com/384363367-dot/legal-os/releases/tag/v0.5.0) 获取源码或一键安装包 `LegalOS-Skills-v0.5.0.zip`。
...
当前公开预发布版本为 v0.5.0。在首个稳定版本发布前，接口、模块边界和仓库结构仍可能调整。版本变更见 [`CHANGELOG.md`](CHANGELOG.md)。
