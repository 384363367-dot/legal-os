...
将 `skills/` 下需要的完整目录复制到 `$CODEX_HOME/skills/`，然后重新启动 Codex。建议先安装 `legal-os-unified-intake`，再按 [`docs/capability-matrix.md`](docs/capability-matrix.md) 选择业务 Skill。
