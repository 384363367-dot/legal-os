...
**状态：** v0.4.0 当前为公共候选，尚未发布。稳定下载仍请使用 [v0.3.0 GitHub Release](https://github.com/384363367-dot/legal-os/releases/tag/v0.3.0)。
...
当前公共候选版本为 v0.4.0，GitHub 稳定预发布版本为 v0.3.0。在首个稳定版本发布前，接口、模块边界和仓库结构仍可能调整。版本变更见 [`CHANGELOG.md`](CHANGELOG.md)。
